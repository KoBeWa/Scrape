...
LEAGUE_RECORD_SCOPES = {
    ...
    "All Play Wins": "R+P",
    "All Play Losses": "R+P",
    "All Play Win Percent": "R+P",

    "Total Points": "R+P",
    "Total Opponent Points": "R+P",
    "Points Share Average": "R+P",
    "Opponent Points Share Average": "R+P",

    "Luckiest": "R+P",
    "Luckiest (Least)": "R+P",

    "Strength of Schedule": "R+P",
    "Strength of Schedule (Easiest)": "R+P",

    "High Scores": "R+P",
    "High Scores Percent": "R+P",
    "Top Scores": "R+P",
    "Top Scores Percent": "R+P",
    "Top Half Scores": "R+P",
    "Top Half Score Percent": "R+P",

    "Worst Scores": "R+P",
    "Worst Scores Percent": "R+P",
    "Bottom Scores": "R+P",
    "Bottom Scores Percent": "R+P",
    "Bottom Half Scores": "R+P",
    "Bottom Half Score Percent": "R+P",
